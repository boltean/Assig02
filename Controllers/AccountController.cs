...
using ZenithCore.Models.AccountViewModels;
using ZenithCore.Services;
using ZenithCore.Controllers;
...
namespace ZenithSocietyCore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> RoleAddToUser(string UserName, string RoleName)
        {
            ...
            var listUsers = _context.Users.OrderBy(u => u.UserName).ToList().Select(uu => new SelectListItem { Value = uu.UserName, Text = uu.UserName }).ToList();
        ...
        //
        // GET: /Account/Loginhttp://localhost:58978/Account/Login
        [HttpGet]
        [AllowAnonymous]
